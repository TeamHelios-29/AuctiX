...
export function AppFooter() {
  return (
    <div>
      <footer className="w-full text-gray-800 py-10 px-6 md:px-12">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-8 lg:space-y-0">
          ...
          <div className="text-center lg:text-left space-y-4 w-full lg:w-auto">
            ...
            <p className="text-sm text-gray-500">
              The Next Gen Auction experience!
            </p>
            {/* Social Icons */}
            <div className="flex justify-center lg:justify-start space-x-3 mt-2">
              <a
                href="#"
                className="p-2 rounded-full hover:bg-gray-200 w-8 h-8 border border-gray-400 flex items-center justify-center"
              >
